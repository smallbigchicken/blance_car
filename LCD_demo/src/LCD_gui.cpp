...
{
    GUI_Clear(WHITE);
    float negative_float = -123.45;
    char float_str[20];
    sprintf(float_str, "%.2f", negative_float);
    GUI_DisString_EN(40, 250, float_str, &Font16, LCD_BACKGROUND, RED);
    ...
    char fs2[20];
    char fs3[20];
    sprintf(fs1, "%.2f", buff[0]);
    sprintf(fs2, "%.2f", buff[1]);
    sprintf(fs3, "%.2f", buff[2]);
    printf("AngleX:%0.3f AngleY:%0.3f AngleZ:%0.3f\n",buff[0],buff[1],buff[2]);
    GUI_DisString_EN(80, 320, fs1, &Font16, LCD_BACKGROUND, BLUE);
    GUI_DisString_EN(80, 340, fs2 , &Font16, LCD_BACKGROUND, BLUE);
    GUI_DisString_EN(80, 360, fs3 , &Font16, LCD_BACKGROUND, BLUE);
...
void GUI_Show(void)
{
    ...
    // DEBUG("Draw Point\r\n"); 宽大往右   高大往下 
    GUI_DisString_EN(40, 320, "X:", &Font20, RED, BLUE);
    GUI_DisString_EN(40, 340, "Y:", &Font20, RED, BLUE);
    GUI_DisString_EN(40, 360, "Z:", &Font20, RED, BLUE);
    ...
    GUI_DisString_EN(40, 120, "speed", &Font24, LCD_BACKGROUND, BLUE);
    GUI_DisString_EN(40, 140, "yaw_rate", &Font24, LCD_BACKGROUND, BLUE);
